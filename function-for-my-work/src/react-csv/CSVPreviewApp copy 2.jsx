  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-6xl">
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-rose-700 to-rose-500 p-6 text-white">
          <h1 className="text-2xl font-bold mb-1">AI CSV Analyzer</h1>
          <p className="text-sm opacity-90">Upload, preview, and analyze CSV data for scientific insights</p>
        </div>
                        ...
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                            <span className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${
                              stats[header]?.dataType === 'numeric' ? 'bg-blue-100 text-blue-800' : 'bg-amber-100 text-amber-800'
                            }`}>
